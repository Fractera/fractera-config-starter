...
import { socialHref, type SocialLink } from "@/lib/settings/socials"
import { SOCIAL_BRANDS, isUploadedIcon } from "@/lib/settings/socials-catalogue"
...
export function SocialsField({
  ...
  return (
    <div data-socials-field className="flex flex-col gap-4">
      ...
      {/* 299-5: ИИ-помощника здесь нет — слово владельца 2026-09-25: «классический стандартный инструмент добавления соцсетей
