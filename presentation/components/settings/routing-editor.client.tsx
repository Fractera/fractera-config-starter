...
import { SLOT_ORDER, LOCKED_SLOTS, DEFAULT_SLOTS, type RoutingMode, type SlotName } from "@/lib/settings/routing"
...
export function RoutingEditor({
  ...
  async function save() {
    ...
    try {
      // 299-5: дверь элемента настроек (JSON Merge Patch: `parallelRouting: null` стирает старое имя).
