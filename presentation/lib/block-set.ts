...
import { FeatureSwitches, SettingsView, SettingsEditor, MenuEditor } from '@/components/settings/blocks'

export const BLOCK_SET: BlockSet = { metrics: Metrics, badges: Badges, cards: Cards, card: Card, flow: Flow, h3: H3, p: P, faq: Faq, featureSwitches: FeatureSwitches, settingsView: SettingsView, settingsEditor: SettingsEditor, menuEditor: MenuEditor }
